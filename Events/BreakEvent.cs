...
public class BreakEvent : IPanel
{
    ...
    public void Render(GameEngine engine)
    {
        ...
        {
            VConsole.WriteLine("=== Табела: Процентно Стакване ===");
            VConsole.WriteLine("На табелата пише:");
            VConsole.WriteLine("Процентните бонуси (+) към дадена характеристика се събират (напр. +50% и +50% = +100%, не +125%).");
            VConsole.WriteLine("Негативните процентни бонуси (-) се пресмятат чрез деление (напр. -100% = /2, -200% = /3).");
        }
        else
        {
