    ...
    private void EnsureOptions(GameEngine engine)
    {
        ...
        switch (_state)
        {
            ...
            case EventState.BeepsHeard:
                _message = "Когато се приближавате, водата започва да бълбука! Чувате далечен глас в главата си.Нещо за... Цвят? На кола?.\nЧувствате се по-силни. (Получихте +4 Атака перманентно!)";
                break;
        }
    }
